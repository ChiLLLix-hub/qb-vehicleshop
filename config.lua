...
Config.Shops = {
    ['pdm'] = {
        ...
        ['PreviewCameraRot'] = vector2(-20.39, -19.90),              -- Camera rotation: tilt (pitch), pan (yaw) in degrees
        ...
        ['ShowroomVehicles'] = {
            ...
            [2] = {
                ...
                defaultVehicle = 'bentaygam',
                chosenVehicle = 'bentaygam'
            },
            [3] = {
                coords = vector4(-39.6, -1096.01, 25.44, 66.5),
                defaultVehicle = '16charger',
                chosenVehicle = '16charger'
            },
            [4] = {
                coords = vector4(-51.21, -1096.77, 25.44, 254.5),
                defaultVehicle = 'ferrari812super',
                chosenVehicle = 'ferrari812super'
            },
            [5] = {
            ...
            [6] = {
                ...
                defaultVehicle = 'huracanpriorbeast',
                chosenVehicle = 'huracanpriorbeast'
            },
            [7] = {
                coords = vector4(-50.66, -1093.05, 25.44, 222.5),
                defaultVehicle = 'GODzYAMR1',
                chosenVehicle = 'GODzYAMR1'
            },
            [8] = {
                coords = vector4(-44.28, -1102.47, 25.44, 298.5),
                defaultVehicle = 'lectro',
                chosenVehicle = 'lectro'
            }
        },
    },
    ['luxury'] = {
        ...
        ['PreviewCameraPos'] = vector4(-1260.0, -360.0, 37.5, 200.0), -- Camera position for vehicle preview
    ...
    ['boats'] = {
        ...
        ['PreviewCameraPos'] = vector4(-735.0, -1330.0, 2.5, 220.0),   -- Camera position for vehicle preview
    ...
    ['air'] = {
        ...
        ['PreviewCameraPos'] = vector4(-1655.0, -3145.0, 15.0, 340.0),   -- Camera position for vehicle preview
    ...
    ['truck'] = {
        ...
        ['PreviewCameraPos'] = vector4(885.0, -1165.0, 26.5, 270.0), -- Camera position for vehicle preview
